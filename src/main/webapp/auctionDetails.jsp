...
<form>
    <div class="container">
        ...
        <%}%>
        <h2>Auction Item(<%out.print(productType);%>): <%
        ...
        <div class="flex-container">
            ...
            <div class="flex-child">
                ...
                <ul>
                    ...
                    <li><h4><span class="strong">Product ID</span>: <%
                    ...
                    <li><h4><span class="strong">Material</span>: <%out.println(boat.getHullMaterial());%></h4>
                    </li>
                    ...
                    <li><h4><span class="strong">Airplane Type</span>: <%out.println(aircraft.getAirCategory());%></h4>
                    </li>
                    <li><h4><span class="strong">Engine Hours</span>: <%out.println(aircraft.getEngineHours());%></h4>
                    </li>
                    <li><h4><span class="strong">Electronic Instruments</span>: <%out.println(aircraft.getAvionics());%></h4></li>
                    <%}%>
                </ul>
            </div>
            ...
            <div class="flex-child" style="text-align: center;">
                <form>
                    ...
                    <p style="font-size: 20px;">Current bid:<span style="font-weight:bold; font-size: 30px;"><%
                        out.print(currency.format(displayPrice));%></span></p>
                    <%}%>
                    <p>[<a href="bidHistory.jsp?listingId=<%out.print(auctionItem.getListingId());%>">Bid
                        History</a>]</p>
                    <p>[<a href="auctionSimilarItems.jsp?listingId=<%out.print(auctionItem.getListingId());%>">
                        Similar Items</a>]</p>
                ...
                <form method="post">
                    ...
                    <button type="submit"  class="autobidbtn" formaction="autobidPlace.jsp">Place Autobid</button>
                </form>
                <%}%>
        ...
        <button onclick="deleteAuction('<%out.print(auctionItem.getListingId());%>')" type="button"
                class="deactivatebtn">Delete Auction
        </button>
        <%} else { %>
        ...
        <br>
        <div class="signin">
            <p><a href="auctionList.jsp">List of auctions</a></p>
        </div>
    </div>
</form>
<% } %>
