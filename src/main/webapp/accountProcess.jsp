...
<%
    ...
    if (request.getParameter("process").equals("edit")) {
        ...
        try {
            ...
            if (result < 1) {
                out.println("<div class=\"container signin\"><p>Error while updating account<br><a href=\"editAccountInformation.jsp\">Try Again</a>.</p> </div>");
            } else {
                ...
                out.println("<div class=\"container signin\"><p>Information Updated successfully<br><a href=\"profile.jsp\">Go to profile page</a>.</p> </div>");
            }
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (result < 1) {
                    ...
                    out.println("<div class=\"container signin\"><p>Account created <br><a href=\"login.jsp\">Please Login</a>.</p> </div>");
                }
            }
        } catch (SQLException se) {
            out.print("<p>Error connecting to MYSQL server.</p>");
